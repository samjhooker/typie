<script>
  ...
  const stats = [
    { value: 0, prefix: '', suffix: '', unit: 'bytes', label: 'of student audio ever transmitted. The architecture has no path out.' },
    { value: 100, prefix: '<', suffix: '', unit: 'ms', label: 'release-to-keystroke latency. Faster than a student can find the period key.' },
    { value: 100, prefix: '', suffix: '%', unit: 'local', label: 'of inference on-device. Works on filtered, throttled, or absent Wi-Fi.' },
    { value: 0, prefix: '$', suffix: '', unit: 'per seat', label: 'for every educator. No licenses, no meters, no procurement cycle.' },
  ];
...
<div class="edu" id="top">
  ...
  <section class="edu-hero">
    <div class="container grid">
      <div>
        <p class="eyebrow hero-eyebrow"><b>typie for education</b>&ensp;/&ensp;K-12 &amp; higher ed</p>
        <h1>
            ...
            >
              ...
              <div class="winbody">
                ...
                <div class="paper">
                  ...
                  {:else if SCENES[hscene].id === 'classroom'}
                    <div class="stream">
                      <div class="shead">
                        ...
                        <div class="swho"><b>Ms. Rivera</b><span class="mono">Cell Bio · just now</span></div>
                      </div>
                      <p class="stream-text">
                        {SCENES[hscene].text.slice(0, hchars)}{#if hchars === 0 && (hphase === 'idle' || hphase === 'switch')}<span class="ghost">words land here, as real keystrokes</span>{/if}<span class="caret" class:hidden={hphase === 'done'} aria-hidden="true"></span>
                      </p>
                  ...
                  {:else}
                    <div class="fields"><span>To: Maya's parents</span><span>Subject: Science project</span></div>
                    <p class="mail-text">
                      {SCENES[hscene].text.slice(0, hchars)}{#if hchars === 0 && (hphase === 'idle' || hphase === 'switch')}<span class="ghost">words land here, as real keystrokes</span>{/if}<span class="caret" class:hidden={hphase === 'done'} aria-hidden="true"></span>
                    </p>
        ...
        <div class="edu-card-wrap primary" use:reveal>
          <div class="edu-card">
            ...
            <p>
              ...
              Docs, Slides, Canvas, PowerSchool, email, legacy gradebooks,
              locked-down exam browsers. If it accepts typing, typie works there.
            </p>
            <pre>$ typie --trace
      ...
      <div class="rows">
        <div class="row" use:reveal>
          ...
          <div class="viz tilt-l">
            <div class="card-note">
              <p class="note-q">&ldquo;Strong thesis — tighten paragraph two and cite your source.&rdquo;</p>
        ...
        <div class="row flip" use:reveal>
          ...
          <div class="viz tilt-r">
            <div class="card-note">
              <p class="note-q">&ldquo;Intro, three body paragraphs, counterclaim, conclusion.&rdquo;</p>
  ...
  <section class="block tight edu-quote">
    <div class="container">
      ...
      <figure style="padding-top:56px">
        ...
        <figcaption use:reveal={{ delay: 0.1 }}>Director of technology &middot; public school district &middot; 4,000 staff MacBooks</figcaption>
      </figure>
    </div>
  </section>
      ...
      <div class="grid">
        ...
        <div class="edu-step" use:reveal={{ delay: 0.16 }}>
          ...
          <p>
            ...
            steep and PD sessions short. Helpdesk tickets stay near zero
            because there is no cloud service to go down.
          </p>
        </div>
      </div>
    </div>
