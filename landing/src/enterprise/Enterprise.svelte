...
>
  ...
  <section class="ent-hero">
    <div class="container grid">
      <div>
        ...
        <p class="sub">
          Enterprise dictation at sub-100ms on every corporate Mac. Audio never
          leaves the device, and there is nothing to breach.
        </p>
        <div class="cta">
          <a
            href="mailto:sales@typie.cc?subject=Enterprise%20briefing"
            ...
            <div class="winbody">
              ...
              <div class="paper">
                ...
                {:else if SCENES[hscene].id === 'terminal'}
                  <p class="term-line">
                    <span class="prompt">$</span> ssh admin@prod-bastion
                  </p>
  ...
  <div class="ent-comply">
    <div class="container row">
      <span
        class="cell"
        use:reveal><i>/</i> SOC 2 Type II</span
      >
      <span
        class="cell"
        use:reveal={{ delay: 0.06 }}><i>/</i> GDPR</span
      >
      <span
        class="cell"
        use:reveal={{ delay: 0.12 }}><i>/</i> HIPAA-ready deployment</span
      >
      <span
        class="cell"
        use:reveal={{ delay: 0.18 }}><i>/</i> CCPA</span
      >
      <span
        class="cell"
        use:reveal={{ delay: 0.24 }}><i>/</i> Zero retention</span
      >
      <span
        class="cell"
      ...
      <div class="grid">
        ...
        >
          <div class="ent-card">
            ...
            <p>
              Output lands as real keyboard events in whatever has focus. Mail,
              Slack, EHR clients, mainframe terminals, Electron abominations. If
...
output     ▸ CGEvent keystrokes ▸ active application</pre>
            <p>
              This is the entire data flow. Three hops, all local. Your auditors
              can verify it with a packet capture in ten minutes.
            </p>
          </div>
        </div>
        ...
        >
          <div class="ent-card">
            ...
            <p>
              ...
              regulatory acronyms. Domain language recognized correctly, on
        ...
        >
          <div class="ent-card">
            ...
            <p>
              ...
              no kernel extensions, no system services.
            </p>
          </div>
        </div>

        <div
          class="ent-card-wrap half"
    ...
    <div class="container">
      ...
      >
        ...
        >
          ...
          <span class="desc"
            >Audio captured only while the hotkey is held. Hold-to-talk means
            recording is <b>physically bounded</b> by the gesture.</span
          >
        </div>
        <div
          class="stage"
        ...
        >
          ...
          <span class="desc"
            >Text enters the target app as synthetic keyboard events. <b
              >No clipboard pollution,</b
            >
        ...
        >
          ...
          <span class="desc"
            >Audio buffers are freed the moment transcription completes. Delete
            the app and <b>nothing remains.</b></span
          >
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <figure style="padding-top:56px">
        ...
        <figcaption use:reveal={{ delay: 0.1 }}>
          CISO &middot; global financial services firm &middot; 40,000 seats
          evaluated
        </figcaption>
      </figure>
    </div>
  ...
  <section class="ent-break">
    <div class="container">
      <h2 use:reveal>
        No servers<i>.</i> No endpoints<i>.</i> No exceptions<i>.</i>
      </h2>
    </div>
  </section>
        ...
        <div>
          ...
          <ul>
            <li>
              <a
                href="/#features"
                use:reveal>Consumer edition</a
              >
            </li>
            <li>
              <a
                href="/#languages"
                use:reveal={{ delay: 0.06 }}>Languages</a
              >
            </li>
            <li>
              <a
                href="/#pricing"
                use:reveal={{ delay: 0.12 }}>Free tier</a
              >
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>
              <a
                href="/privacy"
                use:reveal={{ delay: 0.3 }}>Privacy</a
              >
            </li>
            <li>
              <a
                href="/terms"
                use:reveal={{ delay: 0.36 }}>Terms</a
              >
            </li>
            <li>
              <a
                href="mailto:legal@typie.cc"
                use:reveal={{ delay: 0.42 }}>DPA requests</a
              >
            </li>
          </ul>
        </div>
