...
<style>
  ...
  .talkwave i:nth-child(3n) {
    animation-duration: calc(0.78s + (var(--i) * 0.04s));
  }
  .talkwave i:nth-child(4n) {
    animation-duration: calc(1.18s + (var(--i) * 0.03s));
  }
  .talkwave i:nth-child(odd) {
