...
<section class="beat" id="dictate-beat" aria-label="how typie works">
  <div class="container">
    <p class="line l1" class:set={typed.length > 0}>
      {typed.slice(0, L1.length)}{#if typed.length < L1.length}<i class="caret" aria-hidden="true"></i>{/if}
    </p>
    <p class="line l2" class:set={typed.length > L1.length}>
      {typed.slice(L1.length, L1.length + L2.length)}{#if typed.length >= L1.length && typed.length < L1.length + L2.length}<i class="caret" aria-hidden="true"></i>{/if}
    </p>
    <p class="line l3" class:set={typed.length > L1.length + L2.length}>
      {typed.slice(L1.length + L2.length)}{#if typed.length >= L1.length + L2.length && !done}<i class="caret" aria-hidden="true"></i>{/if}
    </p>
  </div>
</section>
