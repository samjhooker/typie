...
<div class="adocs">
  ...
  <div class="toolbar">
    <span class="file">File</span><span>Edit</span><span>View</span><span>Insert</span><span>Format</span><span>Tools</span>
...
<style>
  .adocs{
    height:100%; background:#eee; font-family:'Inter',system-ui,sans-serif; color:#1f1f1f;
    display:flex; flex-direction:column;
  }
  .topbar{ display:flex; align-items:center; gap:10px; padding:8px 16px; background:#edf2fa; border-bottom:1px solid rgba(0,0,0,.1) }
  .doctitle{ font-size:15px; font-weight:500; color:#444746 }
  .spacer{ flex:1 }
  .star,.comment{ color:#444746; font-size:12px }
  .share{ background:#c2e7ff; color:#001d35; border-radius:99px; padding:5px 16px; font-size:12px; font-weight:600 }
