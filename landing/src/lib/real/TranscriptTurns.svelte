...
<style>
  .turns{ display:flex; flex-direction:column; gap:4px }
  .oturn{
  ...
  .oturn:hover{ background:rgba(253,248,238,.8) }
  ...
  .oname{ font-size:13px; font-weight:700; color:#131722 }
  .ts{
    font-family:'IBM Plex Mono', ui-monospace, monospace;
    font-size:11px; letter-spacing:.05em;
    opacity:.55;
  }
  .otext{ font-size:14px; line-height:1.7; color:rgba(19,23,34,.85) }
</style>
