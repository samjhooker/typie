...
enum Theme {
    ...
    static let cream = Color(hex: 0xFFFDF7)       // --page: the one sheet
    static let paper = Color(hex: 0xFDF8EE)       // subtle inset surfaces
    ...
    static let cardCream = Color(hex: 0xFDF3DC)
